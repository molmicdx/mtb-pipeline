...
singularity exec -B $PWD $SINGULARITY/$GATK gatk LeftAlignAndTrimVariants -R $REFERENCE_GENOME -V $VARIANT_DIR/$1.txt.vcf -O $VARIANT_DIR/$1_normalized.vcf > $VARIANT_DIR/$1_normalized.log 2<&1
echo "Done"
