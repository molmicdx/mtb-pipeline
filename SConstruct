...
singularity = config.get('images', 'singularity')
art_img = config.get('images', 'art')
gatk_img = config.get('images', 'gatk')
cutadapt_img = config.get('images', 'cutadapt')
seqmagick_img = config.get('images', 'seqmagick')
bwa_img = config.get('images', 'bwa')
samtools_img = config.get('images', 'samtools')
bcftools_img = config.get('images', 'bcftools')
bedtools_img = config.get('images', 'bedtools')
discosnp_img = config.get('images', 'discosnp')
freebayes_img = config.get('images', 'freebayes')
